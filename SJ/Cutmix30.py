...
def Create_data(index):
    ...
    for i in range(1,len(female_left_inc)):
        ...
        for j in range(len(female_left_inc)-i):
            ...
            new_path = f'images/00{index}_female_Asian_40'
            ...
            W_data.append([f'{index}','female','Asian','40',f'00{index}_female_Asian_40'])
            print(index,'female')
            index += 1
    ...
    for i in range(1,len(male_left_inc)):
        ...
        for j in range(len(male_left_inc)-i):
            ...
            new_path = f'images/00{index}_male_Asian_40'
            ...
            W_data.append([f'{index}','male','Asian','40',f'00{index}_male_Asian_40'])
            index += 1
            print(index,'male')

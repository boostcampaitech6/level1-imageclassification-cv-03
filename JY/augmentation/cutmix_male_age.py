...
data_dir = '/data/ephemeral/home/jero/multi_ens_code/data/Male'
...
base_path = '/data/ephemeral/home/jero/multi_ens_code/output_male_age'


# young + (old)
young_id = 7040
for i in range(40):
    folder_name = f"{young_id:06d}_male_Asian_60"
...
middle_id = 7140
for i in range(40):
    folder_name = f"{middle_id:06d}_male_Asian_60"
    folder_path = os.path.join(base_path, folder_name)
    try:
        os.makedirs(folder_path)
    except FileExistsError:
...
old_1_id = 7200
for i in range(40):
    folder_name = f"{old_1_id:06d}_male_Asian_20"
    folder_path = os.path.join(base_path, folder_name)
    try:
        os.makedirs(folder_path)
    except FileExistsError:
...
old_2_id = 7240
for i in range(40):
    folder_name = f"{old_2_id:06d}_male_Asian_40"
    folder_path = os.path.join(base_path, folder_name)
    try:
        os.makedirs(folder_path)
    except FileExistsError:
...
'''
img1_path = m_paths0[18]
img1 = Image.open(img1_path)
label1 = torch.tensor([1.0, 0.0])

img2_path = o_paths0[18]
img2 = Image.open(img2_path)
label2 = torch.tensor([0.0, 1.0])

...
def wandb_init(args):
    ...
    wandb.run.name = f"0_{args.model}_{args.epochs}_{args.lr}_{args.criterion}_{args.augmentation}"
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--epochs", type=int, default=5, help="number of epochs to train (default: 1)"
    )
    parser.add_argument(
        "--dataset",
        type=str,
